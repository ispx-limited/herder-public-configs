// Normalizer for the Nokia Beacon neighbour scan.
//
// The Beacons put the neighbour diagnostic under
// InternetGatewayDevice.X_ALU-COM_NeighboringWiFiDiagnostic, with the
// standard TR-181 Result fields. Identical to the baseline normalizer
// but rooted there.
//
// (original: Normalizer for the TR-181 neighbour scan.)
//
...
const ROOT = "InternetGatewayDevice.X_ALU-COM_NeighboringWiFiDiagnostic.";
...
const out: Result = {
  ...
  method: "nokia-alu-neighboring-wifi",
